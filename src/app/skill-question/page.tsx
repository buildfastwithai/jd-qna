...
import { ChevronRight, Plus, Check, Loader2, Trash2 } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export default function SkillQuestion() {
  ...
  const [activeTab, setActiveTab] = useState<"form" | "skills" | "questions">("form");
  ...
  const viewQuestionDetails = (question: Question) => {
    ...
    router.push(`/skill-question/result?data=${questionData}`);
  };
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      <h1 className="text-2xl font-bold mb-6">Skill Question Generator</h1>
          ...
          <Card>
            ...
            <CardFooter className="flex justify-between">
              ...
              <Button variant="outline" onClick={() => {
                ...
                {loading1 && loading2 ? <Spinner size="sm" className="mr-2" /> : null}
